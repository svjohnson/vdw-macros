...
*
*
* Dustin Key (GHRI) 206-287-2916, key.d@ghc.org
* Note: 8/11/2010 Just updated all the macros to reference the new standard vars 
*
*
*********************************************/
...
&_vdw_census.&CensusYear (rename = (mrn = _mrn)) as c
on    i.mrn = c._mrn
;
quit ;
